...
class CourseTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_type" do
    assert_difference('CourseType.count') do
      post course_types_url, params: { course_type: { active: @course_type.active, name: @course_type.name } }
    end
  ...
  test "should update course_type" do
    patch course_type_url(@course_type), params: { course_type: { active: @course_type.active, name: @course_type.name } }
